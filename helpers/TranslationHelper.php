...
class TranslationHelper
{
    private static $translations = [
        ...
        'ar' => [
            ...
            'blog.hero_title' => 'رؤى في',
            'blog.hero_highlight' => 'تطوير الويب الحديث',
            'blog.hero_description' => 'تعمق في Laravel و Vue.js وهندسة المصادر المفتوحة. نشارك ما نتعلمه أثناء البناء على نطاق واسع.',
            ...
            'blog.sidebar_description' => 'نبني تطبيقات ويب متينة، ونساهم في المصادر المفتوحة، ونشارك خبراتنا في Laravel.',
            'blog.github_stars' => 'نجوم GitHub',
            'blog.laravel_prs' => 'مساهمات Laravel',
            'blog.explore_topics' => 'استكشف المواضيع',
