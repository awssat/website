    ...
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden gradient-mesh">
        ...
        <div class="relative z-10 text-center max-w-6xl mx-auto px-4 py-20">
            ...
            <div class="mt-12 flex justify-center gap-4 text-sm animate-on-scroll delay-500">
                <a href="/en/" class="px-4 py-2 rounded-lg bg-primary-100 text-primary-700 dark:bg-primary-900 dark:text-primary-300 font-semibold">English</a>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="relative group animate-on-scroll" x-data="tiltCard()" @mousemove="handleMouseMove" @mouseleave="handleMouseLeave">
                    ...
                    <div class="relative p-8 bg-gray-50 dark:bg-gray-800 rounded-3xl border-2 border-gray-200 dark:border-gray-700 hover:border-primary-500 dark:hover:border-primary-500 transition-all">
                        ...
                        <a href="/en/portfolio" class="text-primary-600 dark:text-primary-400 font-semibold inline-flex items-center group">
                            See contributions
                ...
                <div class="relative group animate-on-scroll" x-data="tiltCard()" @mousemove="handleMouseMove" @mouseleave="handleMouseLeave">
                    ...
                    <div class="relative p-8 bg-gray-50 dark:bg-gray-800 rounded-3xl border-2 border-gray-200 dark:border-gray-700 hover:border-accent-500 dark:hover:border-accent-500 transition-all">
                ...
                <div class="relative group animate-on-scroll" x-data="tiltCard()" @mousemove="handleMouseMove" @mouseleave="handleMouseLeave">
                    ...
                    <div class="relative p-8 bg-gray-50 dark:bg-gray-800 rounded-3xl border-2 border-gray-200 dark:border-gray-700 hover:border-green-500 dark:hover:border-green-500 transition-all">
    ...
    <section class="py-24 px-4 bg-gray-50 dark:bg-gray-950">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mt-12 animate-on-scroll">
                <a href="/en/portfolio" class="inline-flex items-center px-8 py-4 bg-primary-600 hover:bg-primary-700 text-white rounded-2xl font-semibold text-lg shadow-xl hover:shadow-2xl transition-all">
                    View All Work
                    <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                    </svg>
